...
const ImageSchema = new Schema ({               // this aint a schema model. wont be exporting
    url: String,
    filename: String
})
ImageSchema.virtual('thumbnail').get(function() {           // coming from mongoose. not stored in mongo. since url is alrd stored
